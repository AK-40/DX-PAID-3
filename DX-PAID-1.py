...
os.system('espeak -a 300 " Welcome,   to,  The,  DX AJMIR,    Tool"')

os.system('espeak -a 300" TOOL OWNER IS DX AJMIR')
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mDX-AJMIR\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     DX-AJMIRFACEBOOK\033[38;5;46m❴NUMBER❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     DX-AJMIR FACEBOOK\033[38;5;46m❴PASS❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
...
def approval():
	...
	key = "9".join(uuid)
	a=requests.get("https://github.com/AK-40/Approval-/blob/main/Approval.txt").text
	if key in a:
		sykology()
	else:
